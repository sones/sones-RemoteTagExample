...
@XmlRootElement(name = "AlterVertexType")
public class AlterVertexType {
    ...
    @XmlElement(nillable = true)
    protected ServiceAlterVertexChangeset myChangeset;
     ...
     * @return
     *     possible object is
     *     {@link ServiceAlterVertexChangeset }
     *     
     */
    public ServiceAlterVertexChangeset getMyChangeset() {
        return myChangeset;
    }
     ...
     *     
     */
    public void setMyChangeset(ServiceAlterVertexChangeset value) {
