 ...
 *         &lt;element name="myEdgeTypeID" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/>
...
@XmlRootElement(name = "GetEdgeTypeByID")
public class GetEdgeTypeByID {

    @XmlElement(nillable = true)
    protected SecurityToken mySecurityToken;
    protected Long myTransactionToken;
    protected Long myEdgeTypeID;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the myEdgeTypeID property.
     * 
     * @return
     *     possible object is
     *     {@link Long }
     *     
     */
    public Long getMyEdgeTypeID() {
        return myEdgeTypeID;
    }

    /**
     * Sets the value of the myEdgeTypeID property.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setMyEdgeTypeID(Long value) {
        this.myEdgeTypeID = value;
    }
