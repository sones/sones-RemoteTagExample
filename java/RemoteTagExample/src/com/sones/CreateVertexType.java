 ...
 *         &lt;element name="myVertexTypePreDef" type="{http://www.sones.com}ServiceVertexTypePredefinition" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateVertexType")
public class CreateVertexType {
    ...
    @XmlElement(nillable = true)
    protected ServiceVertexTypePredefinition myVertexTypePreDef;
     ...
     *     
     */
    public ServiceVertexTypePredefinition getMyVertexTypePreDef() {
     ...
     *     
     */
    public void setMyVertexTypePreDef(ServiceVertexTypePredefinition value) {
