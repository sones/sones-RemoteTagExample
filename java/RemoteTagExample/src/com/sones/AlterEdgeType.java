 ...
 *         &lt;element name="myChangeset" type="{http://www.sones.com}ServiceAlterEdgeChangeset" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AlterEdgeType")
public class AlterEdgeType {
    ...
    @XmlElement(nillable = true)
    protected ServiceAlterEdgeChangeset myChangeset;
    ...
    /**
     * Gets the value of the myChangeset property.
     * 
     * @return
     *     possible object is
     *     {@link ServiceAlterEdgeChangeset }
     *     
     */
    public ServiceAlterEdgeChangeset getMyChangeset() {
        return myChangeset;
    }

    /**
     * Sets the value of the myChangeset property.
     * 
     * @param value
     *     allowed object is
     *     {@link ServiceAlterEdgeChangeset }
     *     
     */
    public void setMyChangeset(ServiceAlterEdgeChangeset value) {
        this.myChangeset = value;
    }
