 ...
 *         &lt;element name="myVertexTypeNames" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TruncateVertexType")
public class TruncateVertexType {

    @XmlElement(nillable = true)
    protected ServiceSecurityToken mySecurityToken;
    protected Long myTransToken;
    @XmlElement(nillable = true)
    protected String myVertexTypeNames;
     ...
     *     
     */
    public String getMyVertexTypeNames() {
     ...
     *     
     */
    public void setMyVertexTypeNames(String value) {
