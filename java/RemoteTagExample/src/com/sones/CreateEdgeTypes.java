 ...
 *         &lt;element name="myEdgeTypePreDef" type="{http://www.sones.com}ArrayOfServiceEdgeTypePredefinition" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateEdgeTypes")
public class CreateEdgeTypes {

    @XmlElement(nillable = true)
    protected SecurityToken mySecurityToken;
    protected Long myTransactionToken;
    @XmlElement(nillable = true)
    protected ArrayOfServiceEdgeTypePredefinition myEdgeTypePreDef;
    ...
    /**
     * Gets the value of the myEdgeTypePreDef property.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfServiceEdgeTypePredefinition }
     *     
     */
    public ArrayOfServiceEdgeTypePredefinition getMyEdgeTypePreDef() {
        return myEdgeTypePreDef;
    }

    /**
     * Sets the value of the myEdgeTypePreDef property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfServiceEdgeTypePredefinition }
     *     
     */
    public void setMyEdgeTypePreDef(ArrayOfServiceEdgeTypePredefinition value) {
        this.myEdgeTypePreDef = value;
    }
