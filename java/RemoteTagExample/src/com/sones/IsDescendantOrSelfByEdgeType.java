 ...
 *         &lt;element name="myOtherType" type="{http://www.sones.com}ServiceEdgeType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "IsDescendantOrSelfByEdgeType")
public class IsDescendantOrSelfByEdgeType {
    ...
    @XmlElement(nillable = true)
    protected ServiceEdgeType myOtherType;
     ...
     *     
     */
    public ServiceEdgeType getMyOtherType() {
        return myOtherType;
    }
     ...
     *     
     */
    public void setMyOtherType(ServiceEdgeType value) {
