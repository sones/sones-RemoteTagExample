 ...
 *         &lt;element name="myEdgeTypePreDef" type="{http://www.sones.com}ServiceEdgeTypePredefinition" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateEdgeType")
public class CreateEdgeType {
    ...
    @XmlElement(nillable = true)
    protected ServiceEdgeTypePredefinition myEdgeTypePreDef;
     ...
     *     
     */
    public ServiceEdgeTypePredefinition getMyEdgeTypePreDef() {
     ...
     *     
     */
    public void setMyEdgeTypePreDef(ServiceEdgeTypePredefinition value) {
